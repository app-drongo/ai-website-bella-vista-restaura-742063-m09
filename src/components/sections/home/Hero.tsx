...
type LayoutStyle = 'asymmetric' | 'centered';

const DEFAULT_HERO = {
  eyebrow: 'Welcome to Bella Vista',
  headline: 'Where culinary artistry meets',
  headlineEmphasis: 'exceptional dining',
  leadText:
    'Experience the finest Italian cuisine crafted with passion and tradition. Our award-winning chefs transform the freshest ingredients into unforgettable culinary masterpieces that celebrate the authentic flavors of Italy.',
  testimonialText:
    "Bella Vista exceeded all our expectations. The ambiance, service, and food were absolutely perfect. It's become our go-to place for special occasions.",
  testimonialAuthor: 'Maria Rodriguez',
  testimonialRole: 'Food Critic at Culinary Times',
  testimonialRating: 5,
  ...
  statsValue3: '50K+',
  statsLabel3: 'Happy Guests',
  announcementText: "New: Introducing our exclusive Chef's Tasting Menu",
  announcementLink: '/menu/tasting',
