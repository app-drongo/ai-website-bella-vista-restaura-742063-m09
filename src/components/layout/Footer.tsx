...
const DEFAULT_FOOTER = {
  ...
  companyDescription:
    'Experience authentic Italian cuisine in an elegant atmosphere. Our family-owned restaurant has been serving the finest dishes with fresh, locally-sourced ingredients for over two decades.',
  ...
  madeWithText: 'with passion for great food',
  ...
  linkHelp: 'FAQ',
  linkHelpHref: '/faq',
  linkCommunity: 'Reviews',
  linkCommunityHref: '/reviews',
  linkTutorials: 'Cooking Classes',
  linkTutorialsHref: '/classes',
  linkWebinars: 'Virtual Tours',
  linkWebinarsHref: '/tours',
  linkCaseStudies: 'Catering',
  linkCaseStudiesHref: '/catering',
  ...
  linkCompliance: 'Health Standards',
  linkComplianceHref: '/health-standards',
  linkSitemap: 'Sitemap',
