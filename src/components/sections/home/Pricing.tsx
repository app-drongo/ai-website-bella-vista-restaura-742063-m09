...
const DEFAULT_PRICING = {
  ...
  mainTitle: 'Exceptional Dining',
  mainTitleHighlight: 'Options',
  mainDescription:
    'Choose from our carefully curated dining experiences. Each option is designed to provide you with unforgettable moments and exquisite flavors.',
  billingMonthly: 'À la Carte',
  billingAnnual: 'Prix Fixe',
  billingAnnualBadge: 'Best Value',
  plan1Name: 'Casual Dining',
  plan1Description: 'Perfect for everyday dining and quick bites',
  plan1Price: '$25',
  plan1CTA: 'View Menu',
  plan1CTAHref: '/menu/casual',
  plan2Name: 'Fine Dining',
  plan2Description: 'Our signature dining experience with premium service',
  plan2Price: '$85',
  plan2Period: '/person',
  plan2Badge: 'Most Popular',
  plan2CTA: 'Make Reservation',
  plan2CTAHref: '/reservations',
  plan2Trial: 'Includes appetizer, main course & dessert',
  plan3Name: "Chef's Table",
  plan3Description: 'Exclusive culinary journey with our executive chef',
  plan3Price: '$150',
  plan3Badge: 'Premium Experience',
  plan3CTA: 'Book Experience',
  plan3CTAHref: '/chefs-table',
  bottomTitle: 'Planning a special event?',
  bottomDescription:
    'We offer custom catering and private dining experiences for weddings, corporate events, and special celebrations. Let us create the perfect culinary experience for your occasion.',
  bottomCTA: 'Contact Our Events Team',
  bottomCTAHref: '/events',
} as const;
